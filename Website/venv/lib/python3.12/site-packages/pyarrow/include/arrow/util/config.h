...
#define ARROW_CXX_COMPILER_FLAGS "-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -fmessage-length=0 -isystem /opt/anaconda3/include -fdebug-prefix-map=/var/folders/c_/qfmhj66j0tn016nkx_th4hxm0000gp/T/abs_405bb63xoc/croot/arrow-cpp_1707253274529/work=/usr/local/src/conda/arrow-cpp-14.0.2 -fdebug-prefix-map=/opt/anaconda3=/usr/local/src/conda-prefix -Qunused-arguments -fcolor-diagnostics"
